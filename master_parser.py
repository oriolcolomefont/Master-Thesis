...
class MasterParser():
    def __init__(self, clip_duration:float, sample_rat:int, limit:int, base_directory:str):
    ...
    def parse(self, directories=None):
        if directories is None:
            ...
            directories = [os.path.join(self.base_directory, d) for d in os.listdir(self.base_directory) if os.path.isdir(os.path.join(self.base_directory, d))]
